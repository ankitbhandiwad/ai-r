...
const LIVEATC_KDTW_APPROACH_URL = "https://www.liveatc.net/hlisten.php?mount=kdtw_app&icao=kdtw"
...
export function mountFlightViewer(elements) {
  ...
  openAtcButton = elements.openAtcButton
...
function bindEvents() {
  ...
  addManagedListener(openAtcButton, "click", () => {
    window.open(LIVEATC_KDTW_APPROACH_URL, "_blank", "noopener,noreferrer")
  })
